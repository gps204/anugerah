...
<head>
    ...
    {{-- Script editor WYSIWYG sebaiknya dimuat hanya pada halaman yang membutuhkannya --}}
    @stack('styles')
</head>
<body>
    ...
    <div id="content" class="w-100">
        <nav class="navbar navbar-expand navbar-light bg-light p-3">
            ...
            <div class="dropdown">
                <button class="btn btn-light dropdown-toggle" data-bs-toggle="dropdown">
                    <img src="{{ asset('img/iconprofile.jpg') }}" width="40" class="rounded-circle" alt="Profile">
                </button>
                <ul class="dropdown-menu dropdown-menu-end">
